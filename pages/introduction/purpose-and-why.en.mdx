...
By the way, it is not necessary to have a node before you can use Bitcoin. You can use Bitcoin as a savings technology, but without a node you sacrifice a bit of privacy. With this guide, you can set up a Bitcoin and Lightning node that are entirely on the [Tor network](https://en.wikipedia.org/wiki/Tor_%28network%29). An additional benefit of Tor is that your node can be reached from anywhere, despite a [changing IP](https://www.kpn.com/zakelijk/blog/dynamisch-of-statisch-ip-adres-dit-zijn-de-verschillen.htm) by your ISP.
