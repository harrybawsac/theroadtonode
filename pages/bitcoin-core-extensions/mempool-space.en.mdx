...
1. [Electrs](/bitcoin-core-extensies/electrs)
...
* `DIT_WEET_JE_A` en `DIT_WEET_JE_C`: [De user](/bitcoin-core/configuratie-en-starten) die je hebt aangemaakt.
* `DIT_WEET_JE_B` en `DIT_WEET_JE_D`: [Het wachtwoord](/bitcoin-core/configuratie-en-starten) dat je je hebt gekregen.
