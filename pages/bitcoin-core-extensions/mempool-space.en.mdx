...
Now that the backend is taken care of we can focus on the frontend. This starts with navigating to the correct directory.
...
Reaching mempool.space is done through normal internet traffic. That is port 80. Nginx further handles where the traffic goes.
