...
De map waar LND gebruik van wil maken, bestaat nog niet. Maak hem dus eerst aan. Let op: deze configuratie map verschilt van de map waar je LND zojuist in hebt [geïnstalleerd](/lightning/installation), dat was namelijk `/home/ubuntu/lnd`.
...
* **bitcoind.rpcuser**, verander DIT\_WEET\_JE\_A naar [de juiste user](/bitcoin-core/configure-and-start).
* **bitcoind.rpcpass**, verander DIT\_WEET\_JE\_B naar [het juiste wachtwoord](/bitcoin-core/configure-and-start). Dit wachtwoord heb je toebedeeld gekregen.
