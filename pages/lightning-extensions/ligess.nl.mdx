...
Om een macaroon in hex format te aan maken, zie https://github.com/ZeusLN/lnd-hex-macaroon-generator. Als je deze tool hebt geïnstalleerd, gebruik je deze als volgt:
```bash
node index.js
...
[Unit]
Description=Ligess
Requires=ligess.service
After=ligess.service
