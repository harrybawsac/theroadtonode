...
The Lightning Network CLI is kinda fun, but not very practical. That's why we're installing [Ride The Lightning](https://github.com/Ride-The-Lightning/RTL) (RTL). A user-unfriendly front end for LND.
...
```bash
git checkout -f <OUTPUT FROM PREVIOUS STEP> # for example v0.15.1
```
