...
For that you can use this Nginx reverse proxy setup.
...
You can also test/decode your lightning address at [https://lightningdecoder.com](https://lightningdecoder.com) where you can enter `jouw_naam@jouwdomein.com` at Enter Invoice.