...
De Lightning Network CLI \(lncli\) is wel geinig, maar niet heel praktisch. Daarom installeren we [Ride The Lightning](https://github.com/Ride-The-Lightning/RTL) \(RTL\). Een ongebruiksvriendelijk voorkantje voor LND.
