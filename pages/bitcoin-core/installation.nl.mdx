...
Zou je toch een specifieke release willen \(wat op zich wel aan te raden is\), kun je het onderstaande commando uitvoeren. Op moment van schrijven is v25.0 de nieuwste versie.
