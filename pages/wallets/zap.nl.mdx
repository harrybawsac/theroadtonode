...
Waar **xxx.onion** staat, vul je natuurlijk [jouw onion-adres](/lightning/change-tor) in voor de **REST** API van LND. Er zal een lap tekst verschijnen dat iets weg heeft van het volgende.
