...
Sluit de SSD aan. Voer `lsblk` uit om de opslag wat je Pi te zien. Als het goed is zie je het onderstaande scherm verschijnen, of iets dat er heel erg op lijkt. De micro-sd-kaart zal ongeveer `mmcblk0` heten en in dit voorbeeld is `sda` de SSD.
